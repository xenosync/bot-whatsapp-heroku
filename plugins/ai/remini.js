...
if (typeof result == 'undefined' || result == '' || result == null) return m.reply(global.mess.error.api)
mecha.sendMessage(m.chat, {image: result, caption: mess.ok}, {quoted: m, ephemeralExpiration: m.expiration})
