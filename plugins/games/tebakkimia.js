...
const gamesUrl = 'https://suryadev.vercel.app/games/tebakkimia'
...
let id = Date.now();
let caption = `*G A M E - T E B A K K I M I A*\n\n${func.texted('monospace', 'Apa Nama Unsur ' + soal + '?')}\nHadiah: $${hadiah} balance\nWaktu: ${setting.gamewaktu} detik`
player = 0;
database[m.chat] = {
id: id,
...
global.db.users[m.sender].game.tebakkimia += 1
clearTimeout(waktu);
delete database[m.chat];
setTimeout(async () => {
if (player > 1) return
