...
const gamesUrl = 'https://suryadev.vercel.app/games/susunkata'
...
global.db.users[m.sender].game.susunkata += 1
clearTimeout(waktu);
delete database[m.chat];
setTimeout(async () => {
if (player > 1) return
