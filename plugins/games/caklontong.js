...
const gamesUrl = 'https://suryadev.vercel.app/games/caklontong'
...
global.db.users[m.sender].game.caklontong += 1
clearTimeout(waktu);
delete database[m.chat];
setTimeout(async () => {
if (player > 1) return
