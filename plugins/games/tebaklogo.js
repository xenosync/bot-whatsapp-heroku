...
const gamesUrl = 'https://suryadev.vercel.app/games/tebaklogo'
...
global.db.users[m.sender].game.tebaklogo += 1
clearTimeout(waktu);
delete database[m.chat];
setTimeout(async () => {
if (player > 1) return
