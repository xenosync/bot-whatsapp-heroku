...
const gamesUrl = 'https://suryadev.vercel.app/games/asahotak'
...
global.db.users[m.sender].game.asahotak += 1
clearTimeout(waktu);
delete database[m.chat];
setTimeout(async () => {
if (player > 1) return
if (global.db.users[m.sender].limit < 1) return mecha.reply(m.chat, 'Soal dihentikan karena limit kamu sudah habis.', m)
